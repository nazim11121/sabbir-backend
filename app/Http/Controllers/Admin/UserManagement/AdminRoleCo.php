...
class AdminRoleCo extends Controller
{
    ...
    public function create(): View
    {
        ...
        $groupNames = TAdminUser::getPermisionGroups();

        return view('admin.userManagement.roles.create',compact('permission', 'groupNames'));
    }
    ...
    public function edit($id): View
    {
        ...
        $rolePermissions = DB::table("role_has_permissions")->where("role_has_permissions.role_id",$id)
            ...
            $groupNames = TAdminUser::getPermisionGroups();
            $roleHasPermissions = FacadesDB::table('role_has_permissions')->where('role_id', $id)->get();



        return view('admin.userManagement.roles.edit',compact('role','permission','rolePermissions', 'groupNames', 'roleHasPermissions'));
    }
