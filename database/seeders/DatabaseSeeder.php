...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call([
            ...
            TAdminCompanyInfoSeeder::class,
            // TBusinessOwnerSeeder::class,
            TAppTermsAndConditionsSeeder::class,
            TCheckoutTextDataSeeder::class,
            TAdminPermissionSeeder::class,
            TAdminRoleWisePermissionAssignSeeder::class,
            TAdminVersionSeeder::class,
            TAdminBusinessNoteSeeder::class,
            TAdminAddListingFormSeeder::class,
            TAdminPrivacyPolicySeeder::class,
            TBusinessPricingSeeder::class,
            TDashboardTodoListSeeder::class,
        ]);
