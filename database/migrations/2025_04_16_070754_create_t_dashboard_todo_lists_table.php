...
return new class extends Migration
{
    ...
    {
        Schema::create('t_dashboard_todo_lists', function (Blueprint $table) {
            $table->id();
            $table->enum('account_type', ['personal', 'business']);
            $table->string('todo_title', 255);
            $table->boolean('status')->default(1)->comment('1=Active, 0=Inactive');
            $table->boolean('checkbox_status')->default(1)->comment('1=Active, 0=Inactive');
    ...
    {
        Schema::dropIfExists('t_dashboard_todo_lists');
    }
};
