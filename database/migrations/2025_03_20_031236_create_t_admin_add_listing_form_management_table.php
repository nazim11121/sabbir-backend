...
return new class extends Migration
{
    ...
    {
        Schema::create('t_admin_add_listing_form_management', function (Blueprint $table) {
            $table->id();
            $table->string('field_category', 100)->nullable();
            $table->string('field_name', 100);
            $table->boolean('field_status')->default(1)->comment('1=Enabled, 0=Disabled');
    ...
    {
        Schema::dropIfExists('t_admin_add_listing_form_management');
    }
};
