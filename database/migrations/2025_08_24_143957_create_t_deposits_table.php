...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('t_deposits', function (Blueprint $table) {
            ...
            $table->string('binance_id', 191)->nullable();
            $table->string('amount', 11)->nullable();
            $table->string('deposit_proof', 191)->nullable();
            $table->boolean('payment_status', 2)->default(0)->comment('1=Success, 0=Processing, 2=Failed');
