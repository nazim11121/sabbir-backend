                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form class="color-black" method="POST" action="{{ route('privacy-policy.store') }}"
                                    style="color:black">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Description<span
                                                class="requiredStar">*</span></label>
                                        <div class="col-sm-10">
                                            <textarea name="description" class="editor" id="summary-ckeditor">
                                                @isset($data)
                                                {!! $data->description !!}
                                                @else
                                                {{ old('description') }}
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="status"
                                                    id="status" value="1" checked {{ $data->status??''==1 ? 'checked' : 0 }}>
