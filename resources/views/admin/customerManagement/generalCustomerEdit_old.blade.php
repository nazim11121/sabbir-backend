                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12 my-2">
                            <div class="card">
                                ...
                                <div class="collapse" id="businessInfo{{ $sl }}">
                                    ...
                                    @endphp
                                    <form id="userForm" action="{{ route('customers-owner-details.update', $businessOwnerInfo->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="card-body">
                                            <h3>Owner Info</h3>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="d-flex">
                                                                    ...
                                                                    <input type="text" class="form-control" name="first_name" value="{{ $businessOwnerInfo->first_name ?? '' }}">
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="d-flex">
                                                                    <span class="mt-2 mr-2">:</span>
                                                                    <input type="text" class="form-control" name="last_name" value="{{ $businessOwnerInfo->last_name ?? '' }}">
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="d-flex">
                                                                    <span class="mt-2 mr-2">:</span>
                                                                    <input type="text" class="form-control" name="email" value="{{ $businessOwnerInfo->email ?? '' }}">
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="d-flex">
                                                                    <span class="mt-2 mr-2">:</span>
                                                                    <input type="text" class="form-control" name="country_code" value="{{ $businessOwnerInfo->country_code ?? '' }}">
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="d-flex">
                                                                    <span class="mt-2 mr-2">:</span>
                                                                    <input type="text" class="form-control" name="phone_number" value="{{ $businessOwnerInfo->phone_number ?? '' }}">
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="d-flex">
                                                                    <span class="mt-2 mr-2">:</span>
                                                                    <input type="text" class="form-control" name="address" value="{{ $businessOwnerInfo->address ?? '' }}">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    {{-- end owner info --}}
                                    <form id="userForm" action="{{ route('customers-business-details.update', $businessList->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                ...
                                                <table class="table" style="min-width: 845px;color:black">
                                                    <tbody>
                                                        <input type="hidden" class="form-control" name="id" value="{{ $businessList->id ?? '' }}">
                                                        <tr>
                                                            <td>Business Name</td>
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="business_name" value="{{ $businessList->business_name ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="business_email" value="{{ $businessList->business_email ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="country_code" value="{{ $businessList->country_code ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="country_short_code" value="{{ $businessList->country_short_code ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="business_phone_number" value="{{ $businessList->business_phone_number ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="business_website" value="{{ $businessList->business_website ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="address" value="{{ $businessList->address ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="zip_code" value="{{ $businessList->zip_code ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="lat" value="{{ $businessList->lat ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="long" value="{{ $businessList->long ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="description" value="{{ $businessList->description ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="hotline_country_code" value="{{ $businessList->hotline_country_code ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="customer_hotline" value="{{ $businessList->customer_hotline ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="customer_email_leads" value="{{ $businessList->customer_email_leads ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="discount_code" value="{{ $businessList->discount_code ?? '' }}">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex">
                                                                <span class="mt-2 mr-2">:</span>
                                                                <input type="text" class="form-control" name="discount_code_description" value="{{ $businessList->discount_code_description ?? '' }}">
                                                            </td>
                                                        </tr>
...
@push('script')
    ...
    function formatOptions(option) {
        ...
        var $option = $(
            '<div><input type="checkbox" class="select2-checkbox" ' + (option.element.selected ? 'checked' : '') + '> ' + option.text + '</div>'
        );
        return $option;
    }
