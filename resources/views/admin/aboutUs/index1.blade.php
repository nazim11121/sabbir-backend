                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form class="color-black" method="POST" action="{{ route('about-us.store') }}"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Business Title</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Individual Description<span
                                                class="requiredStar">*</span></label>
                                        <div class="col-sm-10">
                                            <textarea name="individual_description" class="form-control"  rows="6" required>
                                                @isset($data)
                                            ...
                                            @error('individual_description')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <p class="requiredStar">**This text format structure must be follow.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Business Description<span
                                                class="requiredStar">*</span></label>
                                        <div class="col-sm-10">
                                            <textarea name="business_description" class="form-control"  rows="6" required>
                                                @isset($data)
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Individual Tab Description<span
                                                class="requiredStar">*</span></label>
                                        <div class="col-sm-10">
                                            <textarea name="individual_tab_description" class="form-control"  rows="6" required>
                                                @isset($data)
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Business Tab Description<span
                                                class="requiredStar">*</span></label>
                                        <div class="col-sm-10">
                                            <textarea name="business_tab_description" class="form-control"  rows="6" required>
                                                @isset($data)
