                    ...
                    <div class="card">
                        <div class="stat-widget-one card-body"
                            ...
                            <div class="stat-content d-inline-block">
                                ...
                                <div class="stat-digit">{{ $totalGeneralProfile }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="stat-widget-one card-body"
                            ...
                            <div class="stat-content d-inline-block">
                                ...
                                <div class="stat-digit">{{ $completeBusinessProfile }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-one card-body"
                            style="display: flex; align-items: center; justify-content: space-between">
                            <div class="stat-icon d-inline-block">
                                <i class="ti-layout-grid2 text-info border-info"></i>
                            </div>
                            <div class="stat-content d-inline-block">
                                <div class="stat-text">Incomplete Business Profile</div>
                                <div class="stat-digit">{{ $incompleteProfile }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="stat-widget-one card-body"
                            ...
                            <div class="stat-content d-inline-block">
                                ...
                                <div class="stat-digit">{{ $totalVisitor }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="recent-comment m-t-15">
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object mr-3"
                                                src="{{ asset('assets/images/avatar/4.png') }}" alt="..."></a>
                                    </div>
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object mr-3"
                                                src="{{ asset('assets/images/avatar/2.png') }}" alt="..."></a>
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#"><img class="media-object mr-3"
                                                src="{{ asset('assets/images/avatar/3.png') }}" alt="..."></a>
                                    </div>
                                    <div class="media-body">
...
@push('script')
    ...
    <script>
        ...
        var options = {
            ...
            axisY: {
                // Y-axis এর লেবেল কাস্টমাইজ করা
                labelInterpolationFnc: function(value) {
                    return value % 1 === 0 ? value : ''; // দশমিক বাদ দিয়ে পূর্ণসংখ্যা দেখাবে
                }
            }
        };
        ...
        var responsiveOptions = [
            ['screen and (max-width: 640px)', {
                ...
                axisX: {
                    labelInterpolationFnc: function(value) {
                        return value[0]; // short form of month
                    }
                }
            }]
        ];
        ...
        // Pignose Calendar (If you want to display calendar)
