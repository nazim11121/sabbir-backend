                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="max-width: 600px;"
                                                        title="{{ $value->keywords->pluck('name')->join(', ') }}">
                                                        @foreach ($value->keywords->sortBy('id') as $keyword)
                                                            <span>{{ $keyword->name }}@if(!$loop->last),@endif
                                                            </span>
                                                        @endforeach
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center align-middle">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        ...
                                                        <a href="{{ route('business-category.edit', $value->id) }}"
                                                        ...
                                                        @can('business-category-delete-btn')
                                                            <form action="{{ route('business-category.destroy', $value->id) }}"
